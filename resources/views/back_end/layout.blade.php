			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URl::to('/admin/addpost')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Add Post</span></a></li>	
						<li><a href="{{URl::to('/admin/allposts')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> All Posts</span></a></li>
						<li><a href="{{URl::to('/admin/publishedposts')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Published Posts</span></a></li>
						<li><a href="{{URl::to('/admin/drafts')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Draft</span></a></li>
						<li>
